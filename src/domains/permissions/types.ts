// Permissions domain: shared role and permission type definitions live here. Do not include UI or implementation details.
// Extracted from src/types/permissions.ts.

export type OrgRole = 'owner' | 'admin' | 'manager' | 'member' | 'viewer';

// Permission for managing assignments (separate from decline_assignment)
export const MANAGE_ASSIGNMENTS_PERMISSION = 'manage_assignments';
...
export const orgPermissions: Permission[] = [
  ...
  { id: 'org-9', key: 'create_roles', label: 'Create Roles', description: 'Create new custom roles at any level' },
  { id: 'org-10', key: 'create_org_roles', label: 'Create Org Roles', description: 'Create new organization-level roles' },
  { id: 'org-11', key: 'create_portfolio_roles', label: 'Create Portfolio Roles', description: 'Create new portfolio-level roles' },
  { id: 'org-12', key: 'create_program_roles', label: 'Create Program Roles', description: 'Create new program-level roles' },
  { id: 'org-13', key: 'create_project_roles', label: 'Create Project Roles', description: 'Create new project-level roles' },
  { id: 'org-14', key: 'view_portfolio', label: 'View Portfolio', description: 'Access the portfolio page' },
  { id: 'org-15', key: 'view_programs', label: 'View Programs', description: 'Access the programs page' },
  { id: 'org-16', key: 'view_projects', label: 'View Projects', description: 'Access the projects page' },
  { id: 'org-17', key: 'view_reports', label: 'View Reports', description: 'Access comprehensive reports and analytics' },
  { id: 'org-18', key: 'export_reports', label: 'Export Reports', description: 'Export reports to PDF/CSV' },
  { id: 'org-19', key: 'view_executive_reports', label: 'View Executive Reports', description: 'Access executive-level summary reports' },
  { id: 'org-20', key: 'view_activity_logs', label: 'View Activity Logs', description: 'Access the activity log tracking all actions' },
  { id: 'org-21', key: 'view_task_reports', label: 'View Task Reports', description: 'Access task-specific reports' },
  { id: 'org-22', key: 'view_project_reports', label: 'View Project Reports', description: 'Access project-specific reports' },
  { id: 'org-23', key: 'view_resource_reports', label: 'View Resource Reports', description: 'Access resource utilization reports' },
...
// High-level permission context used for common checks like “can manage org/projects”.
