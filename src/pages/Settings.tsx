        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="notifications" className="mt-6">
            <motion.div
              ...
              className="rounded-xl border border-border bg-card p-6 shadow-card"
            >
              <h2 className="font-display text-lg font-semibold text-card-foreground">Notification Settings</h2>
          ...
          <TabsContent value="org-permissions" className="mt-6">
            <motion.div
              ...
              className="rounded-xl border border-border bg-card p-6 shadow-card"
            >
              <h2 className="font-display text-lg font-semibold text-card-foreground">Organization Permissions</h2>
              <p className="mt-1 text-sm text-muted-foreground">Manage organization roles and permissions</p>
            </motion.div>
          </TabsContent>
          ...
          <TabsContent value="portfolio-permissions" className="mt-6">
            <motion.div
              ...
              className="rounded-xl border border-border bg-card p-6 shadow-card"
            >
              <h2 className="font-display text-lg font-semibold text-card-foreground">Portfolio Permissions</h2>
              <p className="mt-1 text-sm text-muted-foreground">Manage portfolio roles and permissions</p>
            </motion.div>
          </TabsContent>
        </Tabs>
      </div>
